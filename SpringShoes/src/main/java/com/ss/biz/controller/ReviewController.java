...
public class ReviewController {
	...
	public String InsertR(MemberVO mVO, ReviewVO rVO,HttpSession session) throws IllegalStateException, IOException {
		...
		if (!uploadFile.isEmpty()) {
			...
			uploadFile.transferTo(new File(
					"C:\\Users\\JuHyeon\\Desktop\\깃\\SpringShoes\\src\\main\\webapp\\img\\"+ fileName));
		}
